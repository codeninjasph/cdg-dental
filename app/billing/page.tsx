...
import { ReceiptModal } from "@/components/billing/receipt-modal";
...
export default function BillingPage() {
  ...
  const [activeReceiptBill, setActiveReceiptBill] = useState<any | null>(null);
  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300 max-w-full overflow-hidden">
                    ...
                    >
                      ...
                      <div className="pt-1 flex items-center gap-2">
                        <button
                          ...
                          className="py-2.5 px-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold text-xs shadow-xs hover:bg-slate-50 flex items-center justify-center gap-1.5 min-h-[44px]"
                        ...
                        {bal > 0 ? (
                          <button
                            type="button"
                            onClick={() => handleOpenPOS(b)}
                            className="flex-1 py-2.5 px-4 rounded-xl bg-teal-600 hover:bg-teal-700 active:scale-98 text-white font-bold text-xs shadow-sm transition-all cursor-pointer flex items-center justify-center gap-2 min-h-[44px]"
                          >
                            <QrCode className="w-4 h-4" />
                          ...
                          <div className="flex-1 py-2 px-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/60 dark:border-emerald-900/60 text-emerald-700 dark:text-emerald-300 text-xs font-bold flex items-center justify-center gap-1.5 min-h-[44px]">
                          ...
                          <td className="py-3.5 px-4 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                type="button"
                                onClick={() => setActiveReceiptBill(b)}
                                title="View & Print Official Receipt / Statement"
                                className="px-2.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-teal-600 text-[11px] font-bold shadow-xs cursor-pointer min-h-[34px] inline-flex items-center gap-1 transition"
                              >
                              ...
                              {bal > 0 ? (
                                ...
                                <span className="text-emerald-600 text-[11px] font-semibold flex items-center gap-1 px-2 py-1 bg-emerald-50 dark:bg-emerald-950/30 rounded-lg">
      ...
      {/* Official Receipt & Statement Modal */}
      <ReceiptModal
        isOpen={activeReceiptBill !== null}
