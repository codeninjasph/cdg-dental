            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  {isInstallment
                    ? "Configure orthodontic, implant, or prosthodontic multi-visit payment package"
          ...
          <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 text-xs">
            ...
            <div className="pt-2 flex items-center justify-end gap-2.5">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-500 text-white font-bold text-xs shadow-md shadow-teal-600/20 disabled:opacity-50 transition-all cursor-pointer flex items-center gap-1.5"
              >
